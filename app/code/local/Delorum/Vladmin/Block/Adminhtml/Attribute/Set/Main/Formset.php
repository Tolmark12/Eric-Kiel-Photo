...
class Delorum_Vladmin_Block_Adminhtml_Attribute_Set_Main_Formset extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('attribute_set_name', 'text',
            array(
                'label' => Mage::helper('vladmin')->__('Name<br/>(For internal use)'),
        ...
        if( !$this->getRequest()->getParam('id', false) ) {
            ...
            $fieldset->addField('skeleton_set', 'select',
                array(
                    'label' => Mage::helper('vladmin')->__('Based On'),
                    'name' => 'skeleton_set',
                    'required' => true,
                    'class' => 'required-entry',
                    'values' => $sets,
