...
class Delorum_Vladmin_Adminhtml_SetController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        ...
        $this->loadLayout();
        $this->_setActiveMenu('vladmin/sets');

        $this->_addBreadcrumb(Mage::helper('vladmin')->__('Vladmin'), Mage::helper('vladmin')->__('Vladmin'));
        $this->_addBreadcrumb(Mage::helper('vladmin')->__('Manage Attribute Sets'), Mage::helper('vladmin')->__('Manage Attribute Sets'));

        $this->_addContent($this->getLayout()->createBlock('vladmin/adminhtml_attribute_set_toolbar_main'));
        $this->_addContent($this->getLayout()->createBlock('vladmin/adminhtml_attribute_set_grid'));
    ...
    public function editAction()
    {
        ...
        $this->_addBreadcrumb(Mage::helper('vladmin')->__('Vladmin'), Mage::helper('vladmin')->__('Vladmin'));
        $this->_addBreadcrumb(Mage::helper('vladmin')->__('Manage Template Sets'), Mage::helper('vladmin')->__('Manage Template Sets'));

        $this->_addContent($this->getLayout()->createBlock('vladmin/adminhtml_attribute_set_main'));
    ...
    {
        $this->_setTypeId();
        $this->getResponse()->setBody($this->getLayout()->createBlock('vladmin/adminhtml_attribute_set_grid')->toHtml());
    }
...
//                $response->setMessage($this->getLayout()->getMessagesBlock()->getGroupedHtml());
    ...
    public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('vladmin/adminhtml_attribute_set_toolbar_add'));
