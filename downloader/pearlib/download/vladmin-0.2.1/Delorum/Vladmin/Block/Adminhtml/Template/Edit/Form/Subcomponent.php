...
class Delorum_Vladmin_Block_Adminhtml_Template_Edit_Form_Subcomponent extends Delorum_Vladmin_Block_Adminhtml_Template_Edit_Form_Abstract
{
	protected $_template = "vladmin/template/edit/form/subcomponent.phtml";
	
	public function getTemplateCollection()
	{
		return Mage::getModel('vladmin/template')->getCollection()
