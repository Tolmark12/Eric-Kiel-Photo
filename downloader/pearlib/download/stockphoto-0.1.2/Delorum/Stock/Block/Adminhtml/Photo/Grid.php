...
class Delorum_Stock_Block_Adminhtml_Photo_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('stock/photo')->getCollection();
...
//      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('stock')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
...
//      ));
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(
                    array(
                        'caption'   => Mage::helper('stock')->__('Edit'),
                        'url'       => array('base'=> '*/*/edit'),
                        'field'     => 'id'
                    )
                ),
