...
class Delorum_Vladmin_Block_Adminhtml_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    protected function _construct()
    {
        $this->setTemplate('vladmin/attribute/set/main.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('group_tree',
            $this->getLayout()->createBlock('vladmin/adminhtml_attribute_set_main_tree_group')
        );
        ...
        $this->setChild('delete_group_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('vladmin')->__('Delete Selected Group'),
        ...
        $this->setChild('add_group_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('vladmin')->__('Add New'),
        ...
        $this->setChild('reset_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('vladmin')->__('Reset'),
        ...
        $this->setChild('delete_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('vladmin')->__('Delete Attribute Set'),
                    'onclick'   => 'deleteConfirm(\''. $this->jsQuoteEscape(Mage::helper('vladmin')->__('All template of this set will be deleted! Are you sure you want to delete this attribute set?')) . '\', \'' . $this->getUrl('*/*/delete', array('id' => $setId)) . '\')',
                    'class' => 'delete'
        )));
        ...
        $this->setChild('rename_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('vladmin')->__('New Set Name'),
    ...
    {
        return Mage::helper('vladmin')->__("Edit Attribute Set '%s'", $this->_getSetData()->getAttributeSetName());
    }

    public function getMoveUrl()
    {
        return $this->getUrl('*/adminhtml_set/save', array('id' => $this->_getSetId()));
    }

    public function getGroupUrl()
    {
        return $this->getUrl('*/adminhtml_group/save', array('id' => $this->_getSetId()));
    }
    ...
    public function getAttributeTreeJson()
    {
        ...
        if( count($items) == 0 ) {
            $items[] = array(
                'text' => Mage::helper('vladmin')->__('Empty'),
                'id' => 'empty',
                'cls' => 'folder',
                'allowDrop' => false,
                'allowDrag' => false,
